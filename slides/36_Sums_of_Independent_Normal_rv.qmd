...
$a$ and $b$ are constants. Then $$\hspace{-12cm} Y \sim N(a\mu+b, a^2\sigma^2)$$
:::
:::
...
$$\hspace{-12cm} \sum_{i=1}^n X_i \sim N\Bigg(\sum_{i=1}^n \mu_i, \sum_{i=1}^n \sigma^2_i\Bigg)$$
:::
:::
...
## Detecting and solving sums of Normal RVs from a world problem
