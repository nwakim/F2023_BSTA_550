...
+----------------------------------+------------------------------+
| $X =$ Number of trials needed    | $X =$ Number of failures     |
| for first success (count $x$     | before first success (count  |
| *includes* the success)          | $x$ *does not include* the   |
|                                  | success)                     |
+:================================:+:============================:+
| $p _                             | $p                           |
| X ( x ) = P(X=x) = (1-p)^{x-1}p$ | _X (x)= P(X=x) = (1-p)^{x}p$ |
|                                  |                              |
| for $x=1,2, 3,...$               | for $x=0, 1,2,...$           |
|                                  |                              |
| $F_ X                            | $F_X ( x ) =                 |
|  ( x ) = P(X\leq x) = 1-(1-p)^x$ |  P(X\leq x) = 1-(1-p)^{x+1}$ |
|                                  |                              |
| for $x=1,2, 3,...$               | for $x=0, 1,2,...$           |
+----------------------------------+------------------------------+
