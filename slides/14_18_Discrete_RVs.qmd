...
+---------------------------+-----------------------------+
| $X =$ Number of trials    | $X =$ Number of failures    |
| needed for first success  | before first success (count |
| (count $x$ *includes* the | $x$ *does not include* the  |
| success)                  | success)                    |
+:=========================:+:===========================:+
| $p_X ( x )                | $p_X                        |
|  = P(X=x) = (1-p)^{x-1}p$ | ( x) = P(X=x) = (1-p)^{x}p$ |
|                           |                             |
...
::: ex-cont
A wildlife biologist is using mark-recapture to research
...
::: ex-cont
Suppose a specific study region is known to have 2400
