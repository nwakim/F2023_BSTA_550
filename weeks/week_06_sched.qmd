...
|-------------|-------------|:------------------:|:-------------:|:-----------:|
| 17      | Negative Binomial RV | [[{{< iconify ri slideshow-fill size=30px >}}](/slides/17_Negative_Binomial_rv.qmd)]{style="color:#f8f5f0;"} | [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"} | [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"} |
| 18      | Poisson RV           |      [[{{< iconify ri slideshow-fill size=30px >}}](/slides/18_Poisson_rv.qmd)]{style="color:#f8f5f0;"}      | [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"} | [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"} |
