...
| 24      | Continuous RVs and PDFs | [{{< iconify ph video-fill size=29px >}}]{style="color:#f8f5f0;"} |  [[{{< iconify ri slideshow-fill size=30px >}}](/slides/24_Continuous_rv.qmd)]{style="color:#f8f5f0;"}  | [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"} | [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"} |
| 25      | Joint Densities         | [{{< iconify ph video-fill size=29px >}}]{style="color:#f8f5f0;"} | [[{{< iconify ri slideshow-fill size=30px >}}](/slides/25_Joint_densities.qmd)]{style="color:#f8f5f0;"} | [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"} | [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"} |
