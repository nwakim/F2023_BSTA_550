...
| 28      | Expected value of continuous RVs |        [[{{< iconify ph video-fill size=29px >}}](https://ohsuitg-my.sharepoint.com/personal/wakim_ohsu_edu/_layouts/15/stream.aspx?id=%2Fpersonal%2Fwakim%5Fohsu%5Fedu%2FDocuments%2FTeaching%2FClasses%2FF2023%5FBSTA%5F550%2FMeike%5Frecordings%2F28%20Expected%20Values%2Emp4&referrer=StreamWebApp%2EWeb&referrerScenario=AddressBarCopied%2Eview)]{style="color:#f8f5f0;"}        |                       [{{< iconify ri slideshow-fill size=30px >}}]{style="color:#f8f5f0;"}                       |                            [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"}                            |                                                                                                                                                      [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"}                                                                                                                                                      |
| 29      | Variance of continuous RVs       | [[{{< iconify ph video-fill size=29px >}}](https://ohsuitg-my.sharepoint.com/personal/wakim_ohsu_edu/_layouts/15/stream.aspx?id=%2Fpersonal%2Fwakim%5Fohsu%5Fedu%2FDocuments%2FTeaching%2FClasses%2FF2023%5FBSTA%5F550%2FMeike%5Frecordings%2F29%20Variance%20and%20Sums%20of%20rv%2Emp4&referrer=StreamWebApp%2EWeb&referrerScenario=AddressBarCopied%2Eview)]{style="color:#f8f5f0;"} |                       [{{< iconify ri slideshow-fill size=30px >}}]{style="color:#f8f5f0;"}                       |                            [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"}                            |                                                                                                                                                      [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"}                                                                                                                                                      |
